...
// التقاط طلبات التطبيق وتجاوز فحص تسجيل الدخول بمنح نجاح إجباري وثبات السيريال
app.use((req, res, next) => {
    if (req.headers['user-agent']?.includes('okhttp') || req.path !== '/') {
        let loginKey = '979862374489'; // فرض السيريال الأساسي الثابت لضمان التطابق وتجنب وصوله فارغاً
