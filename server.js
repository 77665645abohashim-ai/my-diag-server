...
app.all('/api/v2/diagsoftservice', (req, res) => {
    ...
    if (requestBody.includes('queryPDTDiagSoftSubPack') || (req.headers['soapaction'] && req.headers['soapaction'].includes('queryPDTDiagSoftSubPack'))) {
        const subPackResponse = `<?xml version="1.0" encoding="UTF-8"?><SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns1="https://diagzone.com"><SOAP-ENV:Body><ns1:queryPDTDiagSoftSubPack><return><code>0</code><message>success</message><!-- أضف بيانات الحزم الفرعية هنا إذا لزم الأمر --></return></ns1:queryPDTDiagSoftSubPack></SOAP-ENV:Body></SOAP-ENV:Envelope>`;
