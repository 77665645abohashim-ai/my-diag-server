...
// 2. خريطة توجيه المسارات الكاملة (المحدثة بجميع روابط السيرفر المطلوبة)
...
// 7. جلب مسارات الـ URLs (تشمل الروابط الجديدة مثل getVersionDetialIds و url-upload)
app.all(['/', '/api/v2/config', '/api/v2/urls'], (req, res) => {
    res.json(fullRoutingResponse);
});

// 8. مسارات التحقق الخاصة بالوصلة وحالة الشبكة
