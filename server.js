...
const fullRoutingResponse = {
    ...
    "data": {
        "urls": [
            ...
            { "key": "user.set_base", "value": "https://my-diag-server.onrender.com/api/v2/user-set-base" },
            { "key": "user.get_base_info_car_logo", "value": "https://my-diag-server.onrender.com/api/v2/user-get-base-info-car-logo" },
            { "key": "area.get_country_list", "value": "https://my-diag-server.onrender.com/api/v2/area-get_country_list" },
            { "key": "userinfo.set_password", "value": "https://my-diag-server.onrender.com/api/v2/set-password" },
            { "key": "addRepairShop", "value": "https://my-diag-server.onrender.com/api/v2/addRepairShop" },
            { "key": "queryRepairShop", "value": "https://my-diag-server.onrender.com/api/v2/queryRepairShop" },
            ...
            { "key": "getAutoCodeByVin", "value": "https://my-diag-server.onrender.com/api/v2/getAutoCodeByVin" },
            { "key": "getAutoEntranceIdByVin", "value": "https://my-diag-server.onrender.com/api/v2/getAutoEntranceIdByVin" },
            ...
            { "key": "binding_tpmsgun_device", "value": "https://my-diag-server.onrender.com/api/v2/binding-pressure-device" },
            ...
            { "key": "adas_register_url", "value": "https://my-diag-server.onrender.com/api/v2/adas-card-reg" },
            ...
            { "key": "burn", "value": "https://my-diag-server.onrender.com/api/v2/burnstatus" },
...
app.all('/api/v2/httapi-report-list', (req, res) => {
    res.json({ "code": 0, "msg": "success", "data": { "reports": [] } });
});
