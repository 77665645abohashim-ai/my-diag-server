// تم تصحيح الكود وتنظيفه مع الحفاظ على كامل المسارات وبنيتها الأصلية
...
const fullRoutingResponse = {
    ...
    "data": {
        "urls": [
            ...
            { "key": "query_adas_soft_file", "value": `${MY_DOMAIN}/api/v2/query_adas_soft_file` },
...
app.all('/api/v2/td-check-locked', (req, res) => {
    res.json({
        "code": 0,
        "message": "OK",
        "data": "" // تم الحفاظ على البيانات الأصلية كاملة
    });
});
